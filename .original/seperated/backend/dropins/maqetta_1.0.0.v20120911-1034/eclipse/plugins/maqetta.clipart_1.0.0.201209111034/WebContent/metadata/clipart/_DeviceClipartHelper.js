...
define(["davinci/Runtime","davinci/model/Path","davinci/ve/themeEditor/metadata/CSSThemeProvider","davinci/ve/themeEditor/metadata/query","davinci/workbench/Preferences"],function(_6,_7,_8,_9,_a){
var _b={_customWidgets:{}},_c={},_d={},_e={},_f={};
dojo.subscribe("/davinci/ui/libraryChanged/start",this,function(){
_f={};
_e={};
});
dojo.subscribe("/davinci/resource/resourceChanged",this,function(_10,_11){
var _12=require("davinci/Workbench");
var _13=_12.getProject();
if(_10=="deleted"||_10=="renamed"){
var _14=_a.getPreferences("davinci.ui.ProjectPrefs",_13);
var _15=new _7(_13).append(_14.themeFolder);
var _16=new _7(_11.getPath());
if(_16.startsWith(_15)){
delete _c[_13];
}
}
if(_11.elementType=="File"&&_11.extension=="theme"){
if(_10=="modified"){
var d=_11.getContent();
d.then(function(_17){
var t=JSON.parse(_17);
t.file=_11;
for(var i=0;i<_c[_13].length;i++){
if(_c[_13][i].name==t.name){
_c[_13][i]=t;
return;
}
}
...
_b={themesChanged:function(_18){
_c[_18]=_18?null:[];
},getThemes:function(_19,_1a,_1b){
if(_1b){
delete _c[_19];
}
function _1c(){
var rlt=[];
if(_c[_19]){
rlt=_1a?_c[_19].filter(function(_1d){
return !_1d.file.isVirtual();
}):_c[_19];
}
return rlt;
};
...
var _1e=_a.getPreferences("davinci.ui.ProjectPrefs",_19),_1f=new _7(_19).append(_1e.themeFolder);
var _20=system.resource.findResource("*.theme",false,_1f.toString());
_c[_19]=[];
for(var i=0;i<_20.length;i++){
if(_20[i]){
var t=JSON.parse(_20[i].getContentSync());
t.file=_20[i];
_c[_19].push(t);
}else{
...
return _1c();
},getThemeMetadata:function(_21){
if(_d[_21.name]){
return _d[_21.name];
}
var _22=new _7(_21.file.getPath()).removeLastSegments();
var _23=_21.files.filter(function(_24){
return _24.indexOf(".css")>-1;
}).map(_22.append,_22);
var _25=_21.meta.map(function(_26){
var _27=_22.append(_26);
return system.resource.findResource(_27.toString());
});
var _28=new _8(_25,_21);
_d[_21.name]={loader:new _9(_25),css:_23,metadata:_28};
return _d[_21.name];
},addCustomWidgets:function(_29,_2a){
var _2b=_a.getPreferences("davinci.ui.ProjectPrefs",_29);
if(!_2b.widgetFolder){
_2b.widgetFolder="./lib/custom";
_a.savePreferences("davinci.ui.ProjectPrefs",_29,_2b);
}
var _2c=require("davinci/ve/metadata").parseMetaData(_2a.name,_2a,new _7(_2b.widgetFolder),true);
if(!_b._customWidgets[_29].hasOwnProperty("name")){
_b._customWidgets[_29].name="custom";
_b._customWidgets[_29].metaPath=_2b.widgetFolder;
_b._customWidgets[_29].localPath=true;
}
_b._customWidgets[_29]=_2c;
dojo.publish("/davinci/ui/addedCustomWidget",[_2c]);
return _2c;
},getCustomWidgets:function(_2d){
if(!_b._customWidgets||!_b._customWidgets[_2d]){
if(!_b._customWidgets){
_b._customWidgets={};
}
if(!_b._customWidgets[_2d]){
_b._customWidgets[_2d]=[];
}
var _2e=_a.getPreferences("davinci.ui.ProjectPrefs",_2d);
if(!_2e.widgetFolder){
_2e.widgetFolder="./lib/custom";
_a.savePreferences("davinci.ui.ProjectPrefs",_2d,_2e);
}
var _2f=new _7(_2d).append(_2e.widgetFolder);
var _30=_2f.getSegments();
parent=system.resource.findResource(_30[0]);
for(var i=1;i<_30.length;i++){
var _31=parent.getChildSync(_30[i]);
if(_31){
parent=_31;
}else{
parent=parent.createResource(_30[i],true);
}
}
var _32=system.resource.findResource("*_widgets.json",false,parent);
for(var i=0;i<_32.length;i++){
_b.addCustomWidgets(_2d,dojo.fromJson(_32[i].getContentSync()));
}
}
return {custom:_b._customWidgets[_2d]};
},getInstalledLibs:function(){
if(!_b._serverLibs){
_b._serverLibs=_6.serverJSONRequest({url:"cmd/listLibs",handleAs:"json",content:{},sync:true})[0].userLibs;
}
return _b._serverLibs;
},getUserLibs:function(_33){
if(_e.base){
return _e.base;
}
_e.base=_6.serverJSONRequest({url:"cmd/getUserLibs",handleAs:"json",content:{base:_33},sync:true})[0].userLibs;
return _e.base;
},getLibRoot:function(id,_34,_35){
var _36=_f;
if(_36[_35]&&_36[_35][id]&&_36[_35][id][_34]!==undefined){
return _36[_35][id][_34];
}
if(!_36[_35]){
_36[_35]={};
}
...
var _37=_6.serverJSONRequest({url:"cmd/getLibRoots",handleAs:"json",content:{libId:id,version:_34,base:_35},sync:true});
var _38=_37?_37[0].libRoot.root:null;
if(!_36[id]){
_36[id]={};
}
_36[_35][id][_34]=_38;
return _38;
},getMetaRoot:function(id,_39){
return _6.serverJSONRequest({url:"cmd/getMetaRoot",handleAs:"text",content:{id:id,version:_39},sync:true});
},modifyLib:function(_3a){
return _6.serverJSONRequest({url:"cmd/modifyLib",handleAs:"text",content:{libChanges:dojo.toJson(_3a)},sync:true});
},addLib:function(id,_3b){
return _6.serverJSONRequest({url:"cmd/getLibRoots",handleAs:"json",content:{libId:id,version:_3b},sync:true})[0].libRoot.root;
},getLibraryId:function(_3c,_3d){
var _3e={sketch:"sketch",claro:"claro"};
return _3e[_3c]+(_3d||"");
...
define(["dojo/_base/declare"],function(_42){
return _42("davinci.ve.commands.ModifyRichTextCommand",null,{name:"modify",constructor:function(_43,_44,_45,_46){
this._oldId=_43?_43.id:undefined;
this._properties=_44=(_44||{});
if(_44.richText){
this._richText=true;
this._newText=_44.richText;
this._children=_44.richText;
delete _44.richText;
}else{
this._children=_44._children;
}
this._context=_46||_43.getContext();
},setContext:function(_47){
this._context=_47;
},add:function(_48){
if(!_48||_48._oldId!=this._oldId){
return;
}
if(_48._properties){
dojo.mixin(this._properties,_48._properties);
}
if(_48._children){
this._children=_48._children;
}
},execute:function(){
if(!this._oldId||!this._properties){
return;
}
var _49=require("davinci/ve/widget");
var _4a=_49.byId(this._oldId);
if(!_4a){
return;
}
this._parentWidget=_4a.getParent();
if(!this._oldText){
this._oldText=_4a._srcElement.getElementText(this._context);
if(this._oldText&&(typeof this._oldText=="string")){
this._oldText=this._oldText.replace(/\n/g,"");
}
}
if(!this._oldData){
this._oldData=_4a.getData();
...
var _4b=null;
var _4c=this._parentWidget.indexOf(_4a);
this._parentWidget.removeChild(_4a);
_4a.destroyWidget();
if(this._newId){
...
_4b=_49.createWidget(this._newData);
if(!_4b){
return;
}
this._parentWidget.addChild(_4b,_4c);
this._newId=_4b.id;
if(this._context){
this._refresh(_4b);
}
this.newWidget=_4b;
dojo.publish("/davinci/ui/widget/replaced",[_4b,_4a]);
var _4d=require("davinci/ve/States");
_4d.resetState(_4b.domNode);
},undo:function(){
if(!this._newId||!this._oldData){
return;
}
var _4e=require("davinci/ve/widget");
var _4f=_4e.byId(this._newId);
if(!_4f){
return;
}
var _50=dojo.indexOf(this._parentWidget.getChildren(),_4f);
if(_50<0){
return;
}
var _51=this._parentWidget.getContext();
if(_51){
_51.detach(_4f);
}
this._parentWidget.removeChild(_4f);
_4f.destroyWidget();
this._oldData.children=this._oldText;
this._oldData.properties.id=this._oldId;
var _52=_4e.createWidget(this._oldData);
_4f.getParent().addChild(_52,_50);
if(_51){
this._refresh(_52);
}
dojo.publish("/davinci/ui/widget/replaced",[_52,_4f]);
var _53=require("davinci/ve/States");
_53.resetState(_52.domNode);
},_refresh:function(_54){
var _55=_54.getContainerNode();
if(_55){
this._context.getGlobal()["require"]("dojo/parser").parse(_55);
}
this._context.attach(_54);
_54.startup();
_54.renderWidget();
if(_55){
this._context._attachChildren(_55);
}
}});
});
},"dojo/date":function(){
...
define(["dojo/_base/declare","davinci/model/resource/Resource","davinci/review/model/resource/Folder","davinci/Runtime","dojo/Deferred"],function(_13fe,_13ff,_1400,_1401,_1402){
var root=_13fe(_13ff,{constructor:function(args){
this.elementType="ReviewRoot";
this.name="root";
this.parent=null;
},findFile:function(_1403,_1404){
var _1405=new _1402();
this.getChildren(function(_1406){
var node=null;
dojo.forEach(_1406,function(item){
if(item.timeStamp==_1403){
node=item;
}
});
var _1407=null;
if(node!=null){
node.getChildren(function(_1408){
dojo.forEach(_1408,function(item){
if(this._fileNamesEqual(item.name,_1404)){
_1407=item;
}
}.bind(this));
_1405.resolve(_1407);
...
return file1===file2;
},findVersion:function(_1409,_140a){
var _140b=new _1402();
this.getChildren(function(_140c){
var _140d=null;
dojo.some(_140c,function(item){
if(item.designerId==_1409&&item.timeStamp==_140a){
_140d=item;
return true;
}
return false;
...
return _140b;
},getChildren:function(_140e,_140f){
if(!this._isLoaded){
if(this._loading){
this._loading.push(_140e);
return;
}
this._loading=[];
this._loading.push(_140e);
_1401.serverJSONRequest({url:"cmd/listVersions",load:dojo.hitch(this,function(_1410,_1411){
this.children=[];
for(var i=0;i<_1410.length;i++){
var child=new _1400(dojo.mixin({name:_1410[i].versionTitle,parent:this},_1410[i]));
this.children.push(child);
}
this._isLoaded=true;
...
define(["dojo/_base/declare","dojo/_base/Deferred","dojo/_base/event","dojo/dom","dojo/dom-attr","dojo/dom-class","dojo/dom-geometry","dojo/dom-style","dojo/has","dojo/keys","dojo/_base/lang","dojo/on","dojo/window","./registry","./focus","./popup","./_FocusMixin"],function(_1412,_1413,event,dom,_1414,_1415,_1416,_1417,has,keys,lang,on,_1418,_1419,focus,popup,_141a){
return _1412("dijit._HasDropDown",_141a,{_buttonNode:null,_arrowWrapperNode:null,_popupStateNode:null,_aroundNode:null,dropDown:null,autoWidth:true,forceWidth:false,maxHeight:0,dropDownPosition:["below","above"],_stopClickEvents:true,_onDropDownMouseDown:function(e){
if(this.disabled||this.readOnly){
return;
}
e.preventDefault();
...
var _141b=this.dropDown,_141c=false;
if(e&&this._opened){
var c=_1416.position(this._buttonNode,true);
if(!(e.pageX>=c.x&&e.pageX<=c.x+c.w)||!(e.pageY>=c.y&&e.pageY<=c.y+c.h)){
var t=e.target;
while(t&&!_141c){
if(_1415.contains(t,"dijitPopup")){
_141c=true;
}else{
t=t.parentNode;
}
...
if(_141c){
t=e.target;
if(_141b.onItemClick){
var _141d;
while(t&&!(_141d=_1419.byNode(t))){
t=t.parentNode;
}
if(_141d&&_141d.onClick&&_141d.getParent){
_141d.getParent().onItemClick(_141d,e);
}
}
return;
}
...
if(this._opened){
if(_141b.focus&&_141b.autoFocus!==false){
...
var _141e={"after":this.isLeftToRight()?"Right":"Left","before":this.isLeftToRight()?"Left":"Right","above":"Up","below":"Down","left":"Left","right":"Right"}[this.dropDownPosition[0]]||this.dropDownPosition[0]||"Down";
_1415.add(this._arrowWrapperNode||this._buttonNode,"dijit"+_141e+"ArrowButton");
},postCreate:function(){
this.inherited(arguments);
...
var d=this.dropDown,_141f=e.target;
...
if(!this._opened&&(e.keyCode==keys.DOWN_ARROW||((e.keyCode==keys.ENTER||e.keyCode==dojo.keys.SPACE)&&((_141f.tagName||"").toLowerCase()!=="input"||(_141f.type&&_141f.type.toLowerCase()!=="text"))))){
...
var _1420=focus.curNode&&this.dropDown&&dom.isDescendant(focus.curNode,this.dropDown.domNode);
this.closeDropDown(_1420);
this.inherited(arguments);
},isLoaded:function(){
return true;
},loadDropDown:function(_1421){
_1421();
},loadAndOpenDropDown:function(){
var d=new _1413(),_1422=lang.hitch(this,function(){
this.openDropDown();
d.resolve(this.dropDown);
});
if(!this.isLoaded()){
this.loadDropDown(_1422);
}else{
_1422();
}
return d;
...
var _1423=this.dropDown,_1424=_1423.domNode,_1425=this._aroundNode||this.domNode,self=this;
if(!this._preparedNode){
this._preparedNode=true;
if(_1424.style.width){
this._explicitDDWidth=true;
}
if(_1424.style.height){
this._explicitDDHeight=true;
}
}
if(this.maxHeight||this.forceWidth||this.autoWidth){
var _1426={display:"",visibility:"hidden"};
...
_1417.set(_1424,_1426);
var _1427=this.maxHeight;
if(_1427==-1){
var _1428=_1418.getBox(this.ownerDocument),_1429=_1416.position(_1425,false);
_1427=Math.floor(Math.max(_1429.y,_1428.h-(_1429.y+_1429.h)));
}
popup.moveOffScreen(_1423);
if(_1423.startup&&!_1423._started){
_1423.startup();
}
var mb=_1416.getMarginSize(_1424);
var _142a=(_1427&&mb.h>_1427);
_1417.set(_1424,{overflowX:"visible",overflowY:_142a?"auto":"visible"});
if(_142a){
mb.h=_1427;
if("w" in mb){
mb.w+=16;
...
if(this.forceWidth){
mb.w=_1425.offsetWidth;
}else{
if(this.autoWidth){
mb.w=Math.max(mb.w,_1425.offsetWidth);
}else{
delete mb.w;
}
}
if(lang.isFunction(_1423.resize)){
_1423.resize(mb);
}else{
_1416.setMarginBox(_1424,mb);
}
}
var _142b=popup.open({parent:this,popup:_1423,around:_1425,orient:this.dropDownPosition,onExecute:function(){
self.closeDropDown(true);
},onCancel:function(){
self.closeDropDown(true);
},onClose:function(){
_1414.set(self._popupStateNode,"popupActive",false);
_1415.remove(self._popupStateNode,"dijitHasDropDownOpen");
self._set("_opened",false);
}});
_1414.set(this._popupStateNode,"popupActive","true");
_1415.add(this._popupStateNode,"dijitHasDropDownOpen");
...
define(["dojo/_base/declare","dijit/_WidgetBase","system/resource","dijit/form/Select","davinci/Workbench"],function(_142c,_142d,_142e,_142f,_1430){
return _142c("davinci.ui.widgets.ProjectSelection",_142d,{postCreate:function(){
_142e.listProjects(dojo.hitch(this,function(_1431){
this.value=_1430.getProject();
this._allProjects=_1431.map(function(_1432){
return _1432.name;
});
this.domNode.removeAttribute("dojoType");
var items=[];
dojo.forEach(_1431,dojo.hitch(this,function(v){
items.push({label:v.name,value:v.name});
}));
this.combo=new _142f({style:"width:100%",options:items});
...
var _1433=dojo.attr(this.combo,"value");
if(this.value!=_1433){
this.value=_1433;
this.onChange();
}
...
define(["dojo/_base/declare","dojo/dom-attr","dojo/_base/event"],function(_1434,_1435,event){
return _1434("dijit.form._CheckBoxMixin",null,{type:"checkbox",value:"on",readOnly:false,_aria_attr:"aria-checked",_setReadOnlyAttr:function(value){
this._set("readOnly",value);
_1435.set(this.focusNode,"readOnly",value);
this.focusNode.setAttribute("aria-readonly",value);
},_setLabelAttr:undefined,_getSubmitValue:function(value){
return !value&&value!==0?"on":value;
},_setValueAttr:function(_1436){
_1436=this._getSubmitValue(_1436);
this._set("value",_1436);
_1435.set(this.focusNode,"value",_1436);
},reset:function(){
this.inherited(arguments);
this._set("value",this.params.value||"on");
_1435.set(this.focusNode,"value",this.value);
},_onClick:function(e){
if(this.readOnly){
event.stop(e);
return false;
...
define(["./_base/kernel","./_base/lang","./_base/array","./_base/declare","./dom","./dom-construct","./parser"],function(_1437,lang,_1438,_1439,dom,_143a,_143b){
var html={};
...
html._emptyNode=_143a.empty;
html._setNodeContent=function(node,cont){
_143a.empty(node);
if(cont){
if(typeof cont=="string"){
cont=_143a.toDom(cont,node.ownerDocument);
}
if(!cont.nodeType&&lang.isArrayLike(cont)){
for(var _143d=cont.length,i=0;i<cont.length;i=_143d==cont.length?i+1:0){
_143a.place(cont[i],node,"last");
}
}else{
_143a.place(cont,node,"last");
}
}
return node;
};
html._ContentSetter=_1439("dojo.html._ContentSetter",null,{node:"",content:"",id:"",cleanContent:false,extractContent:false,parseContent:false,parserScope:_1437._scopeName,startup:true,constructor:function(_143e,node){
lang.mixin(this,_143e||{});
node=this.node=dom.byId(this.node||node);
if(!this.id){
this.id=["Setter",(node)?node.id||node.tagName:"",_143c++].join("_");
}
},set:function(cont,_143f){
if(undefined!==cont){
this.content=cont;
}
if(_143f){
...
var _1440=this.onContentError(e);
try{
node.innerHTML=_1440;
}
catch(e){
...
_1438.forEach(this.parseResults,function(w){
if(w.destroy){
w.destroy();
}
});
...
try{
var _1443={};
_1438.forEach(["dir","lang","textDir"],function(name){
if(this[name]){
_1443[name]=this[name];
}
},this);
var self=this;
this.parseDeferred=_143b.parse({rootNode:_1442,noStart:!this.startup,inherited:_1443,scope:this.parserScope}).then(function(_1444){
return self.parseResults=_1444;
});
}
catch(e){
this._onError("Content",e,"Error parsing in _ContentSetter#"+this.id);
}
},_onError:function(type,err,_1445){
var _1446=this["on"+type+"Error"].call(this,err);
if(_1445){
console.error(_1445,err);
}else{
if(_1446){
html._setNodeContent(this.node,_1446,true);
}
}
}});
html.set=function(node,cont,_1447){
if(undefined==cont){
...
var op=new html._ContentSetter(lang.mixin(_1447,{content:cont,node:node}));
return op.set();
}
};
return html;
...
define(["dojo/_base/declare","davinci/ve/utils/URLRewrite"],function(_1448,_1449){
return _1448("davinci.ve.themeEditor.metadata.query",null,{constructor:function(files,_144a){
this.files=files;
this.cache={};
this.lastLoaded=-1;
this.modules=_144a;
...
this.modulePrefix+="/"+_144a[i];
}
}
},getType:function(_144b){
var type=null;
if(_144b.declaredClass){
type=_144b.type;
}else{
type=_144b;
...
var _144c=this.files[++this.lastLoaded];
var _144d=null;
if(_144c.getURL){
_144d=_1449.encodeURI(_144c.getURL());
}else{
_144d=this.modulePrefix+_144c;
}
var md=null;
dojo.xhrGet({url:_144d,handleAs:"json",sync:true,load:function(_144e){
md=_144e;
}});
return md;
...
define(["dojo/_base/array","dojo/dom-class","dojo/dom-geometry","dojo/dom-style","dojo/_base/lang","../main"],function(array,_145d,_145e,_145f,lang,dijit){
var _1460=lang.getObject("layout",true,dijit);
_1460.marginBox2contentBox=function(node,mb){
...
function size(_1462,dim){
var _1463=_1462.resize?_1462.resize(dim):_145e.setMarginBox(_1462.domNode,dim);
if(_1463){
lang.mixin(_1462,_1463);
}else{
lang.mixin(_1462,_145e.getMarginBox(_1462.domNode));
lang.mixin(_1462,dim);
}
};
_1460.layoutChildren=function(_1464,dim,_1465,_1466,_1467){
dim=lang.mixin({},dim);
_145d.add(_1464,"dijitLayoutContainer");
_1465=array.filter(_1465,function(item){
return item.region!="center"&&item.layoutAlign!="client";
}).concat(array.filter(_1465,function(item){
return item.region=="center"||item.layoutAlign=="client";
}));
array.forEach(_1465,function(child){
...
_1468.left=dim.l+"px";
_1468.top=dim.t+"px";
_1468.position="absolute";
_145d.add(elm,"dijitAlign"+_1461(pos));
var _1469={};
if(_1466&&_1466==child.id){
_1469[child.region=="top"||child.region=="bottom"?"h":"w"]=_1467;
}
...
return {marginBox2contentBox:_1460.marginBox2contentBox,layoutChildren:_1460.layoutChildren};
});
...
define(["dojo/_base/declare","davinci/model/Path","davinci/ve/metadata"],function(_146a,Path,_146b){
return _146a("davinci.de.DijitTemplatedGenerator",null,{constructor:function(args){
dojo.mixin(this,args);
},buildSource:function(model,_146c,_146d,_146e,_146f,_1470){
this.value={js:"",metadata:"",amd:["dojo/_base/declare","dijit/_Widget","dijit/_Templated"]};
this.metadata={id:_146c,name:_146c,spec:"1.0",version:"1.0",require:[],library:{dojo:{src:"../../../../dojo/dojo.js"}}};
this.model=this._srcDocument=model;
var _1471=_1470[0]._srcElement;
var _1472="./"+_146d+".html";
if(!_146e){
this.value.amd.push("dojo/text!"+_1472.toString());
this.value.htmlPath=_1472;
}
var _1473=_1471.find({"elementType":"HTMLElement"});
_1473.push(_1471);
this.loadRequires("html.body",true,true,true);
for(var i=0;i<_1473.length;i++){
var n=_1473[i];
...
this.metadata.require.push({$library:"dojo",format:"amd",src:"widgets/"+_146c.replace(/\./g,"/"),type:"javascript-module"});
this.value.html="";
this.value.html+=_1471.getText();
this.value.html+="";
var _1474=3;
...
this.value.js+="\n],function(";
for(var i=0;i<_1474;i++){
var _1475=this.value.amd[i].split("/");
var _1476=_1475[_1475.length-1];
this.value.js+=_1476;
if(i+1<_1474){
this.value.js+=",";
}
...
this.value.js+="){\n\n";
this.value.js+=" return declare('"+_146c+"',[ _Widget, _Templated";
this.value.js+="], {\n";
...
},loadRequires:function(type,_1478,_1479,_147a){
if(!type){
return false;
}
var _147b=_146b.query(type,"require");
if(!_147b){
return true;
}
_147b.every(function(r){
this.addMetaData(r);
return;
switch(r.type){
case "javascript":
...
define(["dojo/_base/declare","davinci/js/JSElement"],function(_147c,_147d){
return _147c("davinci.js.JSExpression",_147d,{constructor:function(){
...
define(["dojo/_base/declare","dojo/_base/connect","davinci/Runtime","davinci/maqetta/AppStates","./commands/EventCommand","./commands/StyleCommand","davinci/ve/utils/StyleArray"],function(_147e,_147f,_1480,_1481,_1482,_1483,_1484){
var _1485=_147e(_1481,{_update:function(node,_1486){
if(!_1480.currentEditor||_1480.currentEditor.declaredClass!="davinci.ve.PageEditor"){
return;
}
if(!node||!node._dvWidget||(!node._maqAppStates&&node._maqDeltas)){
return;
}
var _1487=node._dvWidget;
this._refresh(_1487);
},_refresh:function(_1488){
var _1489=_1488.getParent();
if(_1489.dijitWidget){
this._refresh(_1489);
}else{
if(_1488&&_1488.resize){
_1488.resize();
}
}
...
var _148a=node._dvWidget;
var _148b=["onclick","onmouseover","onmouseout","onfocus","onblur"];
var _148c;
for(var i in _148b){
var event=_148b[i];
var value=_148a&&_148a.properties&&_148a.properties[event];
...
var _148e=this.getContext();
if(_148e){
var _148f=new _1482(_148a,_148c);
_148e.getCommandStack().execute(_148f);
}
},normalize:function(type,node,name,value){
switch(type){
case "style":
var _1490=this.getStatesListCurrent(node);
for(var i=0;i<_1490.length;i++){
_1490[i]="Normal";
}
var _1491=this.getStyle(node,_1490,name);
if(_1491){
for(var i=0;i<_1491.length;i++){
if(_1491[i][name]){
value=_1491[i][name];
}
}
...
return value;
},normalizeArray:function(type,node,name,_1492){
var _1493=dojo.clone(_1492);
switch(type){
case "style":
var _1494=this.getStatesListCurrent(node);
for(var i=0;i<_1494.length;i++){
_1494[i]="Normal";
}
var _1495=this.getStyle(node,_1494,name);
if(_1495){
for(var i=0;i<_1495.length;i++){
var nItem=_1495[i];
for(var nProp in nItem){
for(var j=_1493.length-1;j>=0;j--){
var vItem=_1493[j];
...
var _1496=this.getEditor();
return _1496&&(_1496.getContext&&_1496.getContext()||_1496.context);
},getDocument:function(){
var _1497=this.getContext();
return _1497&&_1497.getDocument&&_1497.getDocument();
},resetState:function(node){
if(!node){
return;
}
var _1498=this.getStateContainersForNode(node);
var _1499=this.getFocus(node.ownerDocument.body);
for(var i=0;i<_1498.length;i++){
var _149a=_1498[i];
var _149b=this.getState(_149a);
var focus=(_1499&&_149a==_1499.stateContainerNode&&_149b==_1499.state);
this.setState(_149b,_149a,{focus:focus,updateWhenCurrent:true,silent:true});
}
},_updateSrcState:function(node,_149c){
var _149d=(node&&node._dvWidget);
if(!_149d){
return;
}
var _149e=_149d._srcElement.getAttribute(davinci.states.APPSTATES_ATTRIBUTE);
var _149f=_149d._srcElement.getAttribute(davinci.states.DELTAS_ATTRIBUTE);
if(_149d&&_149d._srcElement){
var obj=this.serialize(node);
if(obj.maqAppStates){
obj.maqAppStates.trim();
}
if(obj.maqAppStates){
_149d._srcElement.addAttribute(davinci.states.APPSTATES_ATTRIBUTE,obj.maqAppStates);
}else{
_149d._srcElement.removeAttribute(davinci.states.APPSTATES_ATTRIBUTE);
}
if(obj.maqDeltas){
obj.maqDeltas.trim();
}
if(obj.maqDeltas){
_149d._srcElement.addAttribute(davinci.states.DELTAS_ATTRIBUTE,obj.maqDeltas);
}else{
_149d._srcElement.removeAttribute(davinci.states.DELTAS_ATTRIBUTE);
}
var _14a0=_149d._srcElement.getAttribute(davinci.states.APPSTATES_ATTRIBUTE);
var _14a1=_149d._srcElement.getAttribute(davinci.states.DELTAS_ATTRIBUTE);
if(_149e!==_14a0||_149f!==_14a1){
var _14a2=this.getEditor();
if(_14a2&&_14a2._visualChanged){
_14a2._visualChanged(_149c);
}
}
}
},_removeStateFromNodeRecursive:function(node,state){
var _14a3=node._dvWidget;
if(!node||!_14a3||!state){
return;
}
this._removeStateFromNode(node,state);
var _14a4=_14a3.getChildren();
for(var i=0;i<_14a4.length;i++){
this._removeStateFromNodeRecursive(_14a4[i].domNode,state);
}
...
},removeUnusedStates:function(_14a6){
if(!_14a6){
return;
}
var _14a7=_14a6.getAllWidgets();
for(var i=0;i<_14a7.length;i++){
var node=_14a7[i].domNode;
if(node.tagName!=="BODY"){
if(node&&node._maqDeltas){
var _14a8=this.getAllStatesForNode(node);
for(var state in node._maqDeltas){
if(state!=="undefined"&&_14a8.indexOf(state)<0){
this._removeStateFromNode(node,state);
}
}
}
...
},getApplyToStateIndex:function(_14aa){
var _14ab=this.getState();
var state;
if(_14aa==="current"&&_14ab&&_14ab!="Normal"&&_14ab!="undefined"){
state=_14ab;
}else{
state=undefined;
}
return this._getStateIndex(state);
},propertyDefinedForAnyCurrentState:function(node,_14ac){
var _14ad;
var _14ae=node._maqDeltas;
if(_14ae){
var _14af=this.getStateContainersForNode(node);
outer_loop:
for(var i=_14af.length-1;i>=0;i--){
var _14b0=_14af[i];
var _14b1=this.getState(_14b0);
var _14b2=(!_14b1||_14b1==this.NORMAL)?"undefined":_14b1;
var _14b3=_14ae[_14b2]&&_14ae[_14b2].style;
if(_14b3){
for(var s=0;s<_14b3.length;s++){
var o=_14b3[s];
for(var j=0;j<_14ac.length;j++){
if(o.hasOwnProperty(_14ac[j])){
_14ad=_14b1;
break outer_loop;
}
}
...
if(!this.subscribed){
_147f.subscribe("/maqetta/appstates/state/changed",dojo.hitch(this,function(e){
var _14b4=this.getEditor();
if(!dojo.isObject(e.node)||!_14b4||_14b4.declaredClass!="davinci.ve.PageEditor"){
return;
}
dojo.publish("/maqetta/appstates/state/changed/start",[e]);
var _14b5=(e.node&&e.node._dvWidget);
var _14b5=(_14b5==this.getContext().rootWidget)?_14b5:_14b5.getParent();
var n=_14b5.domNode;
var _14b6=davinci.states._getChildrenOfNode(n);
while(_14b6.length){
var child=_14b6.shift();
if(!this.isContainer(child)){
_14b6=_14b6.concat(davinci.states._getChildrenOfNode(child));
}
var _14b7=this.getStatesArray(child,e.oldState,e.newState,e.stateContainerNode);
this._update(child,_14b7);
}
dojo.publish("/maqetta/appstates/state/changed/end",[e]);
var _14b8=this.getContext();
if(_14b8){
_14b8.clearCachedWidgetBounds();
_14b8.updateFocusAll();
}
}));
_147f.subscribe("/davinci/states/state/renamed",dojo.hitch(this,function(e){
var _14b9=this.getEditor();
if(!_14b9||_14b9.declaredClass=="davinci.themeEditor.ThemeEditor"){
return;
}
var _14ba=(e.node&&e.node._dvWidget);
var _14bb=davinci.states._getChildrenOfNode(e.node);
while(_14bb.length){
var child=_14bb.shift();
if(!this.isContainer(child)){
_14bb=_14bb.concat(davinci.states._getChildrenOfNode(child));
}
...
_147f.subscribe("/davinci/states/state/style/changed",dojo.hitch(this,function(e){
var _14bc=this.getState();
if(_14bc==e.state){
var _14bd=this.findStateContainer(e.node,e.state);
var _14be=this.getStatesArray(e.node,e.state,e.state,_14bd);
this._update(e.node,_14be);
}
}));
_147f.subscribe("/davinci/ui/widget/replaced",dojo.hitch(this,function(_14bf,_14c0){
var _14c1=this.getState();
if(_14c1){
var _14c2=this.findStateContainer(_14bf.domNode,_14c1);
var _14c3=this.getStatesArray(_14bf.domNode,_14c1,_14c1,_14c2);
this._update(_14bf.domNode,_14c3);
}
}));
_147f.subscribe("/davinci/states/state/removed",dojo.hitch(this,function(_14c4){
if(!_14c4){
return;
}
this._removeStateFromNodeRecursive(_14c4.node,_14c4.state);
}));
this.subscribed=true;
}
}});
davinci.ve.states=new _1485();
davinci.ve.states.initialize();
return davinci.ve.states;
});
},"davinci/html/HTMLParser":function(){
define(["dojo/_base/declare","davinci/html/HTMLText","davinci/html/HTMLElement","davinci/html/HTMLAttribute","davinci/html/HTMLComment","davinci/html/PHPBlock","davinci/model/parser/Tokenizer","davinci/html/CSSParser"],function(_14c5,_14c6,_14c7,_14c8,_14c9,_14ca,_14cb,_14cc){
var _14cd=(function(){
var _14ce={autoSelfClosers:{"br":true,"img":true,"hr":true,"link":true,"input":true,"meta":true,"col":true,"frame":true,"base":true,"area":true},doNotIndent:{"pre":true,"!cdata":true}};
var _14cf={autoSelfClosers:{},doNotIndent:{"!cdata":true}};
var _14d0=_14ce;
var _14d1=false;
var _14d2=(function(){
function _14d3(_14d4,_14d5){
var ch=_14d4.next();
if(ch=="<"){
if(_14d4.equals("!")){
_14d4.next();
if(_14d4.equals("[")){
if(_14d4.lookAhead("[CDATA[",true)){
_14d5(_14d6("xml-cdata","]]>"));
return null;
}else{
return "xml-text";
}
}else{
if(_14d4.lookAhead("--",true)){
_14d5(_14d6("xml-comment","-->"));
return null;
}else{
if(_14d4.lookAhead("DOCTYPE",true)){
_14d4.nextWhileMatches(/[\w\._\-]/);
_14d5(_14d6("xml-doctype",">"));
return "xml-doctype";
}else{
return "xml-text";
}
...
if(_14d4.equals("?")){
_14d4.next();
if(_14d4.lookAhead("php",true,false,true)){
_14d5(_14d7("php-block","?>"));
return null;
}else{
_14d4.nextWhileMatches(/[\w\._\-]/);
_14d5(_14d6("xml-processing","?>"));
...
_14d4.nextWhileMatches(/[^&<\n]/);
return "xml-text";
}
}
};
function inTag(_14d8,_14d9){
var ch=_14d8.next();
if(ch==">"){
_14d9(_14d3);
return "xml-punctuation";
}else{
if(/[?\/]/.test(ch)&&_14d8.equals(">")){
_14d8.next();
_14d9(_14d3);
return "xml-punctuation";
}else{
...
function _14da(quote){
return function(_14db,_14dc){
while(!_14db.endOfLine()){
if(_14db.next()==quote){
_14dc(inTag);
break;
}
...
function _14d6(style,_14dd){
return function(_14de,_14df){
while(!_14de.endOfLine()){
if(_14de.lookAhead(_14dd,true)){
_14df(_14d3);
break;
}
_14de.next();
...
function _14d7(style,_14e0){
return function(_14e1,_14e2){
var _14e3=false;
while(!_14e1.endOfLine()){
if(_14e1.lookAhead(_14e0,true)){
_14e3=true;
_14e2(_14d3);
break;
}
...
if(!_14e3&&_14e1.endOfLine()){
_14e1.next();
}else{
while(_14e1.lookAheadRegex(/^[\ \t]/,true)){
}
if(_14e1.endOfLine()){
_14e1.next();
}
...
return _14cb.tokenizer(_14e4,_14e5||_14d3);
};
})();
function _14e6(_14e7){
var _14e8=_14d2(_14e7),token;
var cc=[base];
var _14e9=0,_14ea=0;
var _14eb=null,_14ec=null;
var _14ed;
function push(fs){
...
var _14f4=_14d0.doNotIndent.hasOwnProperty(_14f2)||(_14ec&&_14ec.noIndent);
_14ec={prev:_14ec,name:_14f2,indent:_14ea,startOfLine:_14f3,noIndent:_14f4};
};
function _14f5(){
_14ec=_14ec.prev;
};
function _14f6(_14f7){
return function(_14f8,_14f9){
var _14fa=_14f7;
if(_14fa&&_14fa.noIndent){
return _14f9;
}
if(_14d1&&/<!\[CDATA\[/.test(_14f8)){
return 0;
}
if(_14fa&&/^<\//.test(_14f8)){
_14fa=_14fa.prev;
}
while(_14fa&&!_14fa.startOfLine){
_14fa=_14fa.prev;
}
if(_14fa){
return _14fa.indent+indentUnit;
}else{
return 0;
}
};
...
function base(){
return pass(_14fb,base);
};
var _14fc={"xml-text":true,"xml-entity":true,"xml-comment":true,"xml-processing":true,"xml-doctype":true,"php-block":true};
function _14fb(style,_14fd){
if(_14fd=="<"){
cont(_14fe,_14ff,_1500(_14e9==1));
}else{
if(_14fd=="</"){
cont(_1501,_14ef(">"));
}else{
if(style=="xml-cdata"){
if(!_14ec||_14ec.name!="!cdata"){
_14f1("!cdata");
}
if(/\]\]>$/.test(_14fd)){
_14f5();
...
function _14fe(style,_1502){
if(style=="xml-name"){
_14eb=_1502.toLowerCase();
...
function _1501(style,_1503){
if(style=="xml-name"){
token.style="xml-tagname";
if(_14ec&&_1503.toLowerCase()==_14ec.name){
_14f5();
}else{
_14ee();
}
...
function _1500(_1504){
return function(style,_1505){
if(_1505=="/>"||(_1505==">"&&_14d0.autoSelfClosers.hasOwnProperty(_14eb))){
cont();
}else{
if(_1505==">"){
_14f1(_14eb,_1504);
...
token=_14e8.next();
if(token.style=="whitespace"&&_14e9==0){
_14ea=token.value.length;
}else{
_14e9++;
}
if(token.content=="\n"){
_14ea=_14e9=0;
token.indentation=_14f6(_14ec);
}
...
var _1508=cc.concat([]),_1509=_14e8.state,_150a=_14ec;
var _150b=this;
return function(input){
cc=_1508.concat([]);
_14e9=_14ea=0;
_14ec=_150a;
_14e8=_14d2(input,_1509);
return _150b;
};
}};
};
return {make:_14e6,electricChars:"/",configure:function(_150c){
if(_150c.useHTMLKludges!=null){
_14d0=_150c.useHTMLKludges?_14ce:_14cf;
}
if(_150c.alignCDATA){
_14d1=_150c.alignCDATA;
}
}};
})();
var parse=function(text,_150d){
var _150e={next:function(){
if(++this.count==1){
return text;
}else{
throw StopIteration;
...
var _150f=_14cb.stringStream(_150e);
var _1510=_14cd.make(_150f);
var token;
var _1511=[];
function error(text){
_1511.push(text);
...
var _1512;
var _1513,_1514;
function _1515(text,_1516){
_1512=new _14c6();
_1512.wasParsed=true;
_1512.startOffset=_1516;
stack[stack.length-1].addChild(_1512,undefined,true);
_1512.value=text;
};
function _1517(token){
if(token.content!=token.value){
_1515(token.value.substring(token.content.length),token.offset+token.value.length);
}
};
function _1518(str,_1519){
var lines=str.split("\n");
var _151a=lines[lines.length-1].length;
if(_1519.children.length){
lastElement=_1519.children[_1519.children.length-1];
lastElement._fmLine=lines.length-1;
lastElement._fmIndent=_151a;
}else{
_1519._fmChildLine=lines.length-1;
_1519._fmChildIndent=_151a;
}
};
function _151b(){
if(_1512!=null&&!_1512.value.match(/\S/)){
var _151c=stack[stack.length-1];
_151c.children.pop();
_1518(_1512.value,_151c);
}
_1512=null;
};
function _151d(){
var _151e=stack[stack.length-1];
_150f.nextWhileMatches(/[\s\u00a0]/);
var str=_150f.get();
if(_1512!=null){
_1512.value+=str;
_151b();
...
_14cc.parse(_150f,_151e);
};
function _151f(_1520){
token=_1510.next();
while(_1520&&token.style=="whitespace"){
token=_1510.next();
}
return token;
};
...
while((token=_151f(true)).style=="xml-attname"){
var _1521=new _14c8();
_1521.wasParsed=true;
model.attributes.push(_1521);
_1521.name=token.content;
_1521.startOffset=token.offset;
_151f(true);
if(token.content=="="){
token=_1510.next();
if(token.style=="xml-attribute"){
var s=token.content;
_1521.setValue(s.substring(1,s.length-1));
}else{
...
_1521.endOffset=token.offset-1;
if(_1521.noValue&&token.style!="xml-attname"){
break;
}
}
...
case "xml-entity":
if(_1513){
_1513.value+=token.value;
}else{
if(_1514){
_1514.value+=token.value;
}else{
if(!_1512){
_1515(token.value,token.offset);
}else{
_1512.value+=token.value;
}
}
}
_1514=null;
...
_151b();
var _1523=new _14c9();
_1523.wasParsed=true;
_1523.startOffset=token.offset;
_1523.value=token.content.substring(4,token.content.length-3);
_1523.endOffset=token.offset+token.content.length;
stack[stack.length-1].addChild(_1523,undefined,true);
_1514=null;
break;
case "php-block":
_151b();
var _1524=new _14ca();
_1524.wasParsed=true;
_1524.startOffset=token.offset;
_1524.value=token.content;
_1524.endOffset=token.offset+token.content.length;
stack[stack.length-1].addChild(_1524,undefined,true);
_1514=_1524;
break;
case "xml-doctype":
if(!_1513){
...
_1523.wasParsed=true;
_1523.startOffset=token.offset;
_1523.value=token.value.substring(2);
stack[stack.length-1].addChild(_1523,undefined,true);
_1523.isProcessingInstruction=true;
token=_1510.next();
}
var _1525=token.content.length-1;
if(token.content.charAt(token.content.length-1)==">"){
_1523.endOffset=token.offset+token.content.length;
_1523.value+=token.content.substring(0,_1525);
_1517(token);
_1513=undefined;
}else{
_1513=_1523;
_1523.value+=token.content;
}
_1514=null;
break;
}
...
return {errors:_1511,endOffset:(token?token.offset:0)};
};
return {parse:parse};
});
},"davinci/model/resource/Resource":function(){
define(["dojo/_base/declare","dojo/_base/xhr","dojo/_base/connect","dojo/Deferred","dijit/registry","davinci/Runtime","davinci/model/Model","davinci/model/Path","davinci/ve/utils/URLRewrite"],function(_1526,xhr,_1527,_1528,_1529,_152a,Model,Path,_152b){
return _1526("davinci.model.resource.Resource",Model,{constructor:function(){
...
var _152c=_152a.getUserWorkspaceUrl();
return _152c+path;
},rename:function(_152d){
var _152e=new Path(this.getPath()).removeLastSegments().append(_152d);
return xhr.get({url:"cmd/rename",handleAs:"text",content:{oldName:this.getPath(),newName:_152e.toString()}}).then(function(){
this.name=_152d;
_1527.publish("/davinci/resource/resourceChanged",["renamed",this]);
}.bind(this));
...
},visit:function(_152f,_1530){
var _1531=_152f.visit(this);
if(!this._isLoaded&&this.elementType=="Folder"&&!_1530){
this.getChildren(dojo.hitch(this,function(){
dojo.forEach(this.children,function(child){
child.visit(_152f,_1530);
});
}));
}else{
if(this.children&&!_1531){
dojo.forEach(this.children,function(child){
child.visit(_152f,_1530);
});
}
}
},deleteResource:function(_1532){
var _1533,_1534=function(){
var name=this.getName();
this.parent.children.some(function(child,i,_1535){
if(child.getName()==name){
_1535.splice(i,1);
return true;
}
});
_1527.publish("/davinci/resource/resourceChanged",["deleted",this]);
}.bind(this);
if(_1532){
_1533=new _1528();
_1534();
...
_1533=xhr.get({url:"cmd/deleteResource",handleAs:"text",content:{path:this.getPath()}}).then(_1534,function(){
});
}
return _1533;
},getId:function(){
...
define(["dojo/_base/declare","dojo/_base/kernel","dojo/i18n","./TextBox","../Tooltip","dojo/text!./templates/ValidationTextBox.html","dojo/i18n!./nls/validate"],function(_1536,_1537,i18n,_1538,_1539,_153a){
var _153b;
return _153b=_1536("dijit.form.ValidationTextBox",_1538,{templateString:_153a,required:false,promptMessage:"",invalidMessage:"$_unset_$",missingMessage:"$_unset_$",message:"",constraints:{},pattern:".*",regExp:"",regExpGen:function(){
},state:"",tooltipPosition:[],_deprecateRegExp:function(attr,value){
if(value!=_153b.prototype[attr]){
_1537.deprecated("ValidationTextBox id="+this.id+", set('"+attr+"', ...) is deprecated.  Use set('pattern', ...) instead.","","2.0");
this.set("pattern",value);
}
},_setRegExpGenAttr:function(_153c){
this._deprecateRegExp("regExpGen",_153c);
...
this.inherited(arguments);
this.validate(this.focused);
},validator:function(value,_153d){
return (new RegExp("^(?:"+this._getPatternAttr(_153d)+")"+(this.required?"":"?")+"$")).test(value)&&(!this.required||!this._isEmpty(value))&&(this._isEmpty(value)||this.parse(value,_153d)!==undefined);
},_isValidSubset:function(){
...
var _153e=this.invalidMessage=="$_unset_$"?this.messages.invalidMessage:!this.invalidMessage?this.promptMessage:this.invalidMessage;
var _153f=this.missingMessage=="$_unset_$"?this.messages.missingMessage:!this.missingMessage?_153e:this.missingMessage;
return (this.required&&this._isEmpty(this.textbox.value))?_153f:_153e;
},getPromptMessage:function(){
return this.promptMessage;
},_maskValidSubsetError:true,validate:function(_1540){
var _1541="";
var _1542=this.disabled||this.isValid(_1540);
if(_1542){
this._maskValidSubsetError=true;
}
var _1543=this._isEmpty(this.textbox.value);
var _1544=!_1542&&_1540&&this._isValidSubset();
this._set("state",_1542?"":(((((!this._hasBeenBlurred||_1540)&&_1543)||_1544)&&this._maskValidSubsetError)?"Incomplete":"Error"));
this.focusNode.setAttribute("aria-invalid",_1542?"false":"true");
if(this.state=="Error"){
this._maskValidSubsetError=_1540&&_1544;
_1541=this.getErrorMessage(_1540);
}else{
if(this.state=="Incomplete"){
_1541=this.getPromptMessage(_1540);
this._maskValidSubsetError=!this._hasBeenBlurred||_1540;
}else{
if(_1543){
_1541=this.getPromptMessage(_1540);
}
...
this.set("message",_1541);
return _1542;
},displayMessage:function(_1545){
if(_1545&&this.focused){
_1539.show(_1545,this.domNode,this.tooltipPosition,!this.isLeftToRight());
}else{
_1539.hide(this.domNode);
}
},_refreshState:function(){
if(this._created){
this.validate(this.focused);
...
this.inherited(arguments);
},constructor:function(_1546){
this.constraints={};
this.baseClass+=" dijitValidationTextBox";
},startup:function(){
this.inherited(arguments);
this._refreshState();
},_setConstraintsAttr:function(_1547){
if(!_1547.locale&&this.lang){
_1547.locale=this.lang;
}
this._set("constraints",_1547);
this._refreshState();
},_getPatternAttr:function(_1548){
var p=this.pattern;
var type=(typeof p).toLowerCase();
if(type=="function"){
p=this.pattern(_1548||this.constraints);
}
...
this._refreshState();
},_setMessageAttr:function(_154a){
this._set("message",_154a);
this.displayMessage(_154a);
},reset:function(){
this._maskValidSubsetError=true;
this.inherited(arguments);
},_onBlur:function(){
...
define(["dojo/_base/declare","dojo/_base/xhr","davinci/Runtime","davinci/model/resource/Resource","davinci/model/resource/Marker","davinci/ve/utils/URLRewrite"],function(_154b,xhr,_154c,_154d,_154e,_154f){
return _154b("davinci.model.resource.File",_154d,{constructor:function(name,_1550){
...
this.markers.push(new _154e(this,type,line,text));
},getMarkers:function(_1551){
var _1552=[];
if(this.markers){
for(var i=0;i<this.markers.length;i++){
var _1553=this.markers[i];
if(!_1551){
_1552.push(_1553);
}else{
if(typeof _1551=="string"){
if(_1553.type==_1551){
_1552.push(_1553);
}
}else{
dojo.forEach(_1551,function(type){
if(type==_1553.type){
_1552.push(_1553);
}
});
...
return _1552;
},setContents:function(_1554,_1555){
var _1556=_1555?"true":"false";
var dirty=_1555?true:false;
if(this.isNew&&!_1555){
this.isNew=false;
}
var _1557=_1555?".workingcopy":"";
var path=encodeURI(this.getPath()+_1557);
return xhr.put({url:path,putData:_1554,handleAs:"text",contentType:"text/html"}).then(function(res){
...
return _154c.serverJSONRequest({url:_154f.encodeURI(this.getURL()),handleAs:"text",sync:true});
},getContent:function(){
return xhr.get({url:_154f.encodeURI(this.getURL()),handleAs:"text"});
},removeWorkingCopy:function(){
_154c.serverJSONRequest({url:"cmd/removeWorkingCopy",handleAs:"text",content:{path:this.getPath()},sync:true});
if(this.isNew){
...
define(["dojo/_base/declare","dojo/_base/lang","dojo/number","./RangeBoundTextBox"],function(_1558,lang,_1559,_155a){
var _155b=_1558("dijit.form.NumberTextBoxMixin",null,{pattern:_1559.regexp,value:NaN,editOptions:{pattern:"#.######"},_formatter:_1559.format,postMixInProperties:function(){
this.inherited(arguments);
this._set("type","text");
},_setConstraintsAttr:function(_155c){
var _155d=typeof _155c.places=="number"?_155c.places:0;
if(_155d){
_155d++;
}
if(typeof _155c.max!="number"){
_155c.max=9*Math.pow(10,15-_155d);
}
if(typeof _155c.min!="number"){
_155c.min=-9*Math.pow(10,15-_155d);
}
this.inherited(arguments,[_155c]);
...
var _155e=this.format(val,this.constraints);
if(_155e!==undefined){
this.textbox.value=_155e;
}
}
this.inherited(arguments);
},format:function(value,_155f){
var _1560=String(value);
...
if(!("rangeCheck" in this&&this.rangeCheck(value,_155f))&&_155f.exponent!==false&&/\de[-+]?\d/i.test(_1560)){
return _1560;
}
if(this.editOptions&&this.focused){
_155f=lang.mixin({},_155f,this.editOptions);
}
return this._formatter(value,_155f);
},_parser:_1559.parse,parse:function(value,_1561){
var v=this._parser(value,lang.mixin({},_1561,(this.editOptions&&this.focused)?this.editOptions:{}));
if(this.editOptions&&this.focused&&isNaN(v)){
v=this._parser(value,_1561);
}
return v;
},_getDisplayedValueAttr:function(){
var v=this.inherited(arguments);
...
},serialize:function(value,_1562){
return (typeof value!="number"||isNaN(value))?"":this.inherited(arguments);
},_setBlurValue:function(){
var val=lang.hitch(lang.mixin({},this,{focused:true}),"get")("value");
this._setValueAttr(val,true);
},_setValueAttr:function(value,_1563,_1564){
if(value!==undefined&&_1564===undefined){
_1564=String(value);
if(typeof value=="number"){
if(isNaN(value)){
_1564="";
}else{
if(("rangeCheck" in this&&this.rangeCheck(value,this.constraints))||this.constraints.exponent===false||!/\de[-+]?\d/i.test(_1564)){
_1564=undefined;
}
}
}else{
...
this.inherited(arguments,[value,_1563,_1564]);
},_getValueAttr:function(){
var v=this.inherited(arguments);
if(isNaN(v)&&this.textbox.value!==""){
if(this.constraints.exponent!==false&&/\de[-+]?\d/i.test(this.textbox.value)&&(new RegExp("^"+_1559._realNumberRegexp(lang.mixin({},this.constraints))+"$").test(this.textbox.value))){
...
var _1566=_1558("dijit.form.NumberTextBox",[_155a,_155b],{baseClass:"dijitTextBox dijitNumberTextBox"});
_1566.Mixin=_155b;
return _1566;
});
},"dijit/form/_ComboBoxMenuMixin":function(){
define(["dojo/_base/array","dojo/_base/declare","dojo/dom-attr","dojo/i18n","dojo/i18n!./nls/ComboBox"],function(array,_1567,_1568,i18n){
return _1567("dijit.form._ComboBoxMenuMixin",null,{_messages:null,postMixInProperties:function(){
this.inherited(arguments);
...
this._setSelectedAttr(null);
},_createOption:function(item,_1569){
var _156a=this._createMenuItem();
var _156b=_1569(item);
if(_156b.html){
_156a.innerHTML=_156b.label;
}else{
_156a.appendChild(_156a.ownerDocument.createTextNode(_156b.label));
}
if(_156a.innerHTML==""){
_156a.innerHTML="&#160;";
}
this.applyTextDir(_156a,(_156a.innerText||_156a.textContent||""));
return _156a;
},createOptions:function(_156c,_156d,_156e){
this.items=_156c;
this.previousButton.style.display=(_156d.start==0)?"none":"";
_1568.set(this.previousButton,"id",this.id+"_prev");
array.forEach(_156c,function(item,i){
var _156f=this._createOption(item,_156e);
_156f.setAttribute("item",i);
_1568.set(_156f,"id",this.id+i);
this.nextButton.parentNode.insertBefore(_156f,this.nextButton);
},this);
var _1570=false;
if(_156c.total&&!_156c.total.then&&_156c.total!=-1){
if((_156d.start+_156d.count)<_156c.total){
_1570=true;
}else{
if((_156d.start+_156d.count)>_156c.total&&_156d.count==_156c.length){
_1570=true;
}
}
}else{
if(_156d.count==_156c.length){
_1570=true;
}
}
this.nextButton.style.display=_1570?"":"none";
_1568.set(this.nextButton,"id",this.id+"_next");
},clearResultList:function(){
var _1571=this.containerNode;
while(_1571.childNodes.length>2){
_1571.removeChild(_1571.childNodes[_1571.childNodes.length-2]);
}
this._setSelectedAttr(null);
...
define(["dojo/_base/array","dojo/_base/connect","dojo/cookie","dojo/_base/declare","dojo/Deferred","dojo/DeferredList","dojo/dom","dojo/dom-class","dojo/dom-geometry","dojo/dom-style","dojo/_base/event","dojo/errors/create","dojo/fx","dojo/_base/kernel","dojo/keys","dojo/_base/lang","dojo/on","dojo/topic","dojo/touch","dojo/when","./focus","./registry","./_base/manager","./_Widget","./_TemplatedMixin","./_Container","./_Contained","./_CssStateMixin","dojo/text!./templates/TreeNode.html","dojo/text!./templates/Tree.html","./tree/TreeStoreModel","./tree/ForestStoreModel","./tree/_dndSelector"],function(array,_1572,_1573,_1574,_1575,_1576,dom,_1577,_1578,_1579,event,_157a,_157b,_157c,keys,lang,on,topic,touch,when,focus,_157d,_157e,_157f,_1580,_1581,_1582,_1583,_1584,_1585,_1586,_1587,_1588){
_1575=_1574(_1575,{addCallback:function(_1589){
this.then(_1589);
},addErrback:function(_158a){
this.then(null,_158a);
}});
var _158b=_1574("dijit._TreeNode",[_157f,_1580,_1581,_1582,_1583],{item:null,isTreeNode:true,label:"",_setLabelAttr:{node:"labelNode",type:"innerText"},isExpandable:null,isExpanded:false,state:"UNCHECKED",templateString:_1584,baseClass:"dijitTreeNode",cssStateNodes:{rowNode:"dijitTreeRow"},_setTooltipAttr:{node:"rowNode",type:"attribute",attribute:"title"},buildRendering:function(){
this.inherited(arguments);
this._setExpando();
...
},_setIndentAttr:function(_158c){
var _158d=(Math.max(_158c,0)*this.tree._nodePixelIndent)+"px";
_1579.set(this.domNode,"backgroundPosition",_158d+" 0px");
_1579.set(this.indentNode,this.isLeftToRight()?"paddingLeft":"paddingRight",_158d);
array.forEach(this.getChildren(),function(child){
child.set("indent",_158c+1);
});
this._set("indent",_158c);
...
var _158e="_"+lower+"Class";
var _158f=lower+"Node";
var _1590=this[_158e];
this[_158e]=this.tree["get"+upper+"Class"](item,this.isExpanded);
_1577.replace(this[_158f],this[_158e]||"",_1590||"");
_1579.set(this[_158f],this.tree["get"+upper+"Style"](item,this.isExpanded)||{});
},_updateLayout:function(){
var _1591=this.getParent();
if(!_1591||!_1591.rowNode||_1591.rowNode.style.display=="none"){
_1577.add(this.domNode,"dijitTreeIsRoot");
}else{
_1577.toggle(this.domNode,"dijitTreeIsLast",!this.getNextSibling());
}
},_setExpando:function(_1592){
var _1593=["dijitTreeExpandoLoading","dijitTreeExpandoOpened","dijitTreeExpandoClosed","dijitTreeExpandoLeaf"],_1594=["*","-","+","*"],idx=_1592?0:(this.isExpandable?(this.isExpanded?1:2):3);
_1577.replace(this.expandoNode,_1593[idx],_1593);
this.expandoNodeText.innerHTML=_1594[idx];
},expand:function(){
...
_1577.add(this.contentNode,"dijitTreeContentExpanded");
this._setExpando();
this._updateItemClasses(this.item);
if(this==this.tree.rootNode&&this.tree.showRoot){
this.tree.domNode.setAttribute("aria-expanded","true");
}
var def,_1595=_157b.wipeIn({node:this.containerNode,duration:_157e.defaultDuration,onEnd:function(){
def.resolve(true);
}});
def=(this._expandDeferred=new _1575(function(){
_1595.stop();
}));
_1595.play();
return def;
...
_1577.remove(this.contentNode,"dijitTreeContentExpanded");
this._setExpando();
this._updateItemClasses(this.item);
var def,_1596=_157b.wipeOut({node:this.containerNode,duration:_157e.defaultDuration,onEnd:function(){
def.resolve(true);
}});
def=(this._collapseDeferred=new _1575(function(){
_1596.stop();
}));
_1596.play();
return def;
...
var _1597=this.getChildren();
array.forEach(_1597,function(child){
_1581.prototype.removeChild.call(this,child);
},this);
this.defer(function(){
array.forEach(_1597,function(node){
...
array.forEach(items,function(item){
var id=model.getIdentity(item),_1598=tree._itemNodesMap[id],node;
if(_1598){
for(var i=0;i<_1598.length;i++){
if(_1598[i]&&!_1598[i].getParent()){
node=_1598[i];
...
this.inherited(arguments);
var _1599=this.getChildren();
if(_1599.length==0){
this.isExpandable=false;
this.collapse();
}
array.forEach(_1599,function(child){
child._updateLayout();
});
},makeExpandable:function(){
this.isExpandable=true;
this._setExpando(false);
},setSelected:function(_159a){
this.labelNode.setAttribute("aria-selected",_159a?"true":"false");
_1577.toggle(this.rowNode,"dijitTreeRowSelected",_159a);
},setFocusable:function(_159b){
this.labelNode.setAttribute("tabIndex",_159b?"0":"-1");
},_setTextDirAttr:function(_159c){
if(_159c&&((this.textDir!=_159c)||!this._created)){
this._set("textDir",_159c);
this.applyTextDir(this.labelNode,this.labelNode.innerText||this.labelNode.textContent||"");
array.forEach(this.getChildren(),function(_159d){
_159d.set("textDir",_159c);
},this);
}
}});
var Tree=_1574("dijit.Tree",[_157f,_1580],{store:null,model:null,query:null,label:"",showRoot:true,childrenAttr:["children"],paths:[],path:[],selectedItems:null,selectedItem:null,openOnClick:false,openOnDblClick:false,templateString:_1585,persist:true,autoExpand:false,dndController:_1588,dndParams:["onDndDrop","itemCreator","onDndCancel","checkAcceptance","checkItemAcceptance","dragThreshold","betweenThreshold"],onDndDrop:null,itemCreator:null,onDndCancel:null,checkAcceptance:null,checkItemAcceptance:null,dragThreshold:5,betweenThreshold:0,_nodePixelIndent:19,_publish:function(_159e,_159f){
topic.publish(this.id,lang.mixin({tree:this,event:_159e},_159f||{}));
},postMixInProperties:function(){
this.tree=this;
if(this.autoExpand){
this.persist=false;
...
this.expandChildrenDeferred=new _1575();
...
_15a0[this.dndParams[i]]=this[this.dndParams[i]];
}
}
this.dndController=new this.dndController(this,_15a0);
}
this._load();
...
_157c.deprecated("Tree: from version 2.0, should specify a model object rather than a store/query");
var _15a1={id:this.id+"_ForestStoreModel",store:this.store,query:this.query,childrenAttrs:this.childrenAttr};
if(this.params.mayHaveChildren){
_15a1.mayHaveChildren=lang.hitch(this,"mayHaveChildren");
}
if(this.params.getItemChildren){
_15a1.getChildren=lang.hitch(this,function(item,_15a2,_15a3){
this.getItemChildren((this._v10Compat&&item===this.model.root)?null:item,_15a2,_15a3);
});
}
this.model=new _1587(_15a1);
...
var _15a4=this.model.getIdentity(item);
if(this._itemNodesMap[_15a4]){
this._itemNodesMap[_15a4].push(rn);
}else{
this._itemNodesMap[_15a4]=[rn];
}
rn._updateLayout();
...
var _15a5=lang.isString(item)?item:this.model.getIdentity(item);
return [].concat(this._itemNodesMap[_15a5]);
...
var _15a6=array.map(items,function(item){
return (!item||lang.isString(item))?item:tree.model.getIdentity(item);
});
var nodes=[];
array.forEach(_15a6,function(id){
...
return new _1576(array.map(paths,function(path){
var d=new _1575();
path=array.map(path,function(item){
return lang.isString(item)?item:tree.model.getIdentity(item);
});
if(path.length){
_15a7(path,[tree.rootNode],d);
}else{
...
function _15a7(path,nodes,def){
var _15a9=path.shift();
var _15aa=array.filter(nodes,function(node){
return node.getIdentity()==_15a9;
})[0];
if(!!_15aa){
if(path.length){
tree._expandNode(_15aa).then(function(){
_15a7(path,_15aa.getChildren(),def);
});
}else{
def.resolve(_15aa);
}
}else{
def.reject(new Tree.PathError("Could not expand path at "+_15a9));
}
};
function _15a8(_15ab){
tree.set("selectedNodes",array.map(array.filter(_15ab,function(x){
return x[0];
}),function(x){
return x[1];
}));
...
_15ac._expandNode(node).then(function(){
var _15ae=array.filter(node.getChildren()||[],function(node){
return node.isExpandable;
}),defs=array.map(_15ae,_15ad);
...
return _15ad(this.rootNode);
},collapseAll:function(){
var _15af=this;
function _15b0(node){
var def=new dojo.Deferred();
def.label="collapseAllDeferred";
var _15b1=array.filter(node.getChildren()||[],function(node){
return node.isExpandable;
}),defs=array.map(_15b1,_15b0);
new dojo.DeferredList(defs).then(function(){
if(!node.isExpanded||(node==_15af.rootNode&&!_15af.showRoot)){
def.resolve(true);
}else{
_15af._collapseNode(node).then(function(){
def.resolve(true);
});
}
});
...
return _15b0(this.rootNode);
},mayHaveChildren:function(){
},getItemChildren:function(){
},getLabel:function(item){
return this.model.getLabel(item);
},getIconClass:function(item,_15b2){
return (!item||this.model.mayHaveChildren(item))?(_15b2?"dijitFolderOpened":"dijitFolderClosed"):"dijitLeaf";
...
return "";
},_onKeyPress:function(_15b3,e){
if(e.charCode<=32){
return;
}
if(!e.altKey&&!e.ctrlKey&&!e.shiftKey&&!e.metaKey){
var c=String.fromCharCode(e.charCode);
this._onLetterKeyNav({node:_15b3,key:c.toLowerCase()});
event.stop(e);
}
},_onKeyDown:function(_15b4,e){
var key=e.keyCode;
...
this[this._keyHandlerMap[key]]({node:_15b4,item:_15b4.item,evt:e});
event.stop(e);
}
},_onEnterKey:function(_15b5){
this._publish("execute",{item:_15b5.item,node:_15b5.node});
this.dndController.userSelect(_15b5.node,_1572.isCopyKey(_15b5.evt),_15b5.evt.shiftKey);
this.onClick(_15b5.item,_15b5.node,_15b5.evt);
},_onDownArrow:function(_15b6){
var node=this._getNextNode(_15b6.node);
if(node&&node.isTreeNode){
this.focusNode(node);
}
},_onUpArrow:function(_15b7){
var node=_15b7.node;
var _15b8=node.getPreviousSibling();
if(_15b8){
node=_15b8;
while(node.isExpandable&&node.isExpanded&&node.hasChildren()){
var _15b9=node.getChildren();
node=_15b9[_15b9.length-1];
}
}else{
var _15ba=node.getParent();
if(!(!this.showRoot&&_15ba===this.rootNode)){
node=_15ba;
}
}
if(node&&node.isTreeNode){
...
},_onLeftArrow:function(_15bc){
var node=_15bc.node;
if(node.isExpandable&&node.isExpanded){
this._collapseNode(node);
}else{
var _15bd=node.getParent();
if(_15bd&&_15bd.isTreeNode&&!(!this.showRoot&&_15bd===this.rootNode)){
this.focusNode(_15bd);
}
}
},_onHomeKey:function(){
...
},multiCharSearchDuration:250,_onLetterKeyNav:function(_15be){
var cs=this._curSearch;
if(cs){
cs.pattern=cs.pattern+_15be.key;
cs.timer.remove();
}else{
cs=this._curSearch={pattern:_15be.key,startNode:_15be.node};
}
...
},isExpandoNode:function(node,_15bf){
return dom.isDescendant(node,_15bf.expandoNode);
},_onClick:function(_15c0,e){
var _15c1=e.target,_15c2=this.isExpandoNode(_15c1,_15c0);
if((this.openOnClick&&_15c0.isExpandable)||_15c2){
if(_15c0.isExpandable){
this._onExpandoClick({node:_15c0});
}
}else{
this._publish("execute",{item:_15c0.item,node:_15c0,evt:e});
this.onClick(_15c0.item,_15c0,e);
this.focusNode(_15c0);
}
event.stop(e);
},_onDblClick:function(_15c3,e){
var _15c4=e.target,_15c5=(_15c4==_15c3.expandoNode||_15c4==_15c3.expandoNodeText);
if((this.openOnDblClick&&_15c3.isExpandable)||_15c5){
if(_15c3.isExpandable){
this._onExpandoClick({node:_15c3});
}
}else{
this._publish("execute",{item:_15c3.item,node:_15c3,evt:e});
this.onDblClick(_15c3.item,_15c3,e);
this.focusNode(_15c3);
}
event.stop(e);
},_onExpandoClick:function(_15c6){
var node=_15c6.node;
this.focusNode(node);
if(node.isExpanded){
this._collapseNode(node);
...
var model=this.model,item=node.item,_15c8=this;
if(!node._loadDeferred){
node.markProcessing();
node._loadDeferred=new _1575();
...
console.error(_15c8,": error loading "+node.label+" children: ",err);
...
var model=this.model,_15c9=model.getIdentity(item),nodes=this._itemNodesMap[_15c9];
if(nodes){
var label=this.getLabel(item),_15ca=this.getTooltip(item);
array.forEach(nodes,function(node){
node.set({item:item,label:label,tooltip:_15ca});
node._updateItemClasses(item);
});
}
},_onItemChildrenChange:function(_15cb,_15cc){
var model=this.model,_15cd=model.getIdentity(_15cb),_15ce=this._itemNodesMap[_15cd];
if(_15ce){
array.forEach(_15ce,function(_15cf){
_15cf.setChildItems(_15cc);
});
}
},_onItemDelete:function(item){
var model=this.model,_15d0=model.getIdentity(item),nodes=this._itemNodesMap[_15d0];
if(nodes){
array.forEach(nodes,function(node){
this.dndController.removeTreeNode(node);
var _15d1=node.getParent();
if(_15d1){
_15d1.removeChild(node);
}
node.destroyRecursive();
},this);
delete this._itemNodesMap[_15d0];
}
},_initState:function(){
this._openedNodes={};
if(this.persist&&this.cookieName){
var oreo=_1573(this.cookieName);
if(oreo){
...
_1573(this.cookieName,ary.join(","),{expires:365});
}
}
},destroy:function(){
if(this._curSearch){
...
this.destroy();
},resize:function(_15d3){
if(_15d3){
_1578.setMarginBox(this.domNode,_15d3);
}
this._nodePixelIndent=_1578.position(this.tree.indentDetector).w||this._nodePixelIndent;
...
var _15d4=0,nodes=[];
function _15d5(_15d6){
var node=_15d6.rowNode;
node.style.width="auto";
_15d4=Math.max(_15d4,node.clientWidth);
nodes.push(node);
if(_15d6.isExpanded){
array.forEach(_15d6.getChildren(),_15d5);
}
};
_15d5(this.rootNode);
_15d4=Math.max(_15d4,_1578.getContentBox(this.domNode).w);
array.forEach(nodes,function(node){
node.style.width=_15d4+"px";
});
},_createTreeNode:function(args){
return new _158b(args);
},_setTextDirAttr:function(_15d7){
if(_15d7&&this.textDir!=_15d7){
this._set("textDir",_15d7);
this.rootNode.set("textDir",_15d7);
}
}});
Tree.PathError=_157a("TreePathError");
Tree._TreeNode=_158b;
return Tree;
});
},"davinci/model/Comment":function(){
define(["dojo/_base/declare","davinci/model/Model"],function(_15d8,Model){
return _15d8("davinci.model.Comment",Model,{constructor:function(){
...
var _15d9=this.comments[this.comments.length-1];
_15d9.s+=text;
_15d9.stop+=text.length;
},getText:function(_15da){
var s="";
...
define(["require","dojo/_base/declare","dojo/dom-class","dojo/has","dojo/_base/kernel","dojo/_base/lang","dojo/ready","./_FormWidget","./_ButtonMixin","dojo/text!./templates/Button.html"],function(_15db,_15dc,_15dd,has,_15de,lang,ready,_15df,_15e0,_15e1){
if(has("dijit-legacy-requires")){
ready(0,function(){
var _15e2=["dijit/form/DropDownButton","dijit/form/ComboButton","dijit/form/ToggleButton"];
_15db(_15e2);
});
}
return _15dc("dijit.form.Button",[_15df,_15e0],{showLabel:true,iconClass:"dijitNoIcon",_setIconClassAttr:{node:"iconNode",type:"class"},baseClass:"dijitButton",templateString:_15e1,_setValueAttr:"valueNode",_onClick:function(e){
...
return ok;
},_fillContent:function(_15e3){
if(_15e3&&(!this.params||!("label" in this.params))){
var _15e4=lang.trim(_15e3.innerHTML);
if(_15e4){
this.label=_15e4;
}
}
...
if(this.containerNode){
_15dd.toggle(this.containerNode,"dijitDisplayNone",!val);
}
this._set("showLabel",val);
},setLabel:function(_15e5){
_15de.deprecated("dijit.form.Button.setLabel() is deprecated.  Use set('label', ...) instead.","","2.0");
this.set("label",_15e5);
},_setLabelAttr:function(_15e6){
this.inherited(arguments);
...
define(["dojo/_base/declare","dojo/_base/window","dojo/_base/lang","dojo/dom-attr","dojo/parser","./_Widget","./metadata"],function(_15e7,_15e8,dlang,_15e9,_15ea,_15eb,_15ec){
var _15ed="__DijitWidgetScratchSpace";
return _15e7("davinci.ve.DijitWidget",_15eb,{isDijitWidget:true,constructor:function(mixin,node,_15ee,_15ef,_15f0){
if(typeof _15ee==="string"){
var type=_15e9.get(node,"data-dojo-type")||_15e9.get(node,"dojoType");
if(!type){
_15e9.set(node,"data-dojo-type",_15ee);
}
if(_15f0){
_15f0.addAttribute("data-dojo-type",_15ee);
}
var doc=node.ownerDocument,win=doc.defaultView,ss=doc[_15ed];
if(!ss){
ss=doc[_15ed]=doc.createElement("div");
}
ss.appendChild(node);
var _15f1=win.require("dojo/parser").instantiate([node],mixin,{noStart:true});
_15ee=_15f1[0];
if(ss.firstChild){
ss.removeChild(ss.firstChild);
}
this.domNode=_15ee.domNode;
_15ee.domNode._dvWidget=this;
this.isLayoutContainer=_15ee.isLayoutContainer;
}else{
this.type=_15ee.declaredClass;
}
var _15f2=davinci.ve.metadata.getAllowedChild(this.type);
this.acceptsHTMLChildren=_15f2[0]==="ANY"||_15f2.indexOf("HTML")!==-1;
this.dijitWidget=_15ee;
this.containerNode=_15ee.containerNode;
this.styleNode=_15ee.styleNode;
this.id=_15ee.id;
},getParent:function(){
var _15f3;
...
do{
_15f3=require("davinci/ve/widget").getEnclosingWidget(this.dijitWidget.domNode.parentNode);
}while(_15f3&&_15f3.dijitWidget&&_15f3.dijitWidget.declaredClass.split(".").pop().charAt(0)=="_");
return _15f3;
},_getChildren:function(_15f4){
...
if(_15f4){
_15f5.push(require("davinci/ve/widget").getWidget(child.domNode));
}else{
var _15f6=child.domNode&&child.domNode._dvWidget;
if(_15f6){
_15f5.push(_15f6);
}
}
...
},selectChild:function(_15f7){
if(this.dijitWidget.selectChild){
this.dijitWidget.selectChild(_15f7.dijitWidget);
}
},addChild:function(child,index){
if(this.dijitWidget.addChild&&child.dijitWidget){
if(typeof index==="number"&&index>=0){
var _15f8=this.getChildren();
if(index<_15f8.length){
this._srcElement.insertBefore(child._srcElement,_15f8[index]._srcElement);
}else{
...
},_addChildHelper:function(_15f9,index){
var _15fa=this.getHelper();
if(_15fa&&_15fa.addChild){
_15fa.addChild(this,_15f9,index);
}else{
this.dijitWidget.addChild(_15f9,index);
}
},_addChildHooked:function(_15fb,index){
var _15fc=this.dijitWidget,_15fd=_15fc.getChildren;
_15fc.getChildren=dojo.hitch(this,this.getChildren);
var _15fe=this.getHelper();
if(_15fe&&_15fe.addChild){
_15fe.addChild(this,_15fb,index);
}else{
_15fc.addChild(_15fb,index);
}
_15fc.getChildren=_15fd;
},removeChild:function(child){
if(!child){
return;
}
...
var _15ff=this.getContext();
var djit=_15ff.getDijit();
var _1600=this.dijitWidget.isInstanceOf(djit.layout._LayoutWidget);
return _1600;
},resize:function(){
var _1601=this.getHelper();
if(_1601&&_1601.resize){
_1601.resize(this);
}else{
...
var _1602=node.parentNode;
if(_1602._dvWidget&&_1602._dvWidget.isDijitWidget){
this._refresh(_1602);
}else{
...
define(["dojo/_base/array","dojo/_base/declare","dojo/cldr/supplemental","dojo/date","dojo/date/locale","dojo/date/stamp","dojo/dom","dojo/dom-class","dojo/_base/event","dojo/_base/lang","dojo/sniff","dojo/string","./_WidgetBase","./_TemplatedMixin","dojo/text!./templates/Calendar.html","./hccss"],function(array,_1603,_1604,date,_1605,stamp,dom,_1606,event,lang,has,_1607,_1608,_1609,_160a){
var _160b=_1603("dijit.CalendarLite",[_1608,_1609],{templateString:_160a,dowTemplateString:"<th class=\"dijitReset dijitCalendarDayLabelTemplate\" role=\"columnheader\"><span class=\"dijitCalendarDayLabel\">${d}</span></th>",dateTemplateString:"<td class=\"dijitReset\" role=\"gridcell\" data-dojo-attach-point=\"dateCells\"><span class=\"dijitCalendarDateLabel\" data-dojo-attach-point=\"dateLabels\"></span></td>",weekTemplateString:"<tr class=\"dijitReset dijitCalendarWeekTemplate\" role=\"row\">${d}${d}${d}${d}${d}${d}${d}</tr>",value:new Date(""),datePackage:"",dayWidth:"narrow",tabIndex:"0",currentFocus:new Date(),baseClass:"dijitCalendar",_isValidDate:function(value){
...
},_setValueAttr:function(value,_160c){
if(typeof value=="string"){
...
if(this._created&&(_160c||typeof _160c=="undefined")){
...
month.setDate(1);
var _160d=month.getDay(),_160e=this.dateModule.getDaysInMonth(month),_160f=this.dateModule.getDaysInMonth(this.dateModule.add(month,"month",-1)),today=new this.dateClassObj(),_1610=_1604.getFirstDayOfWeek(this.lang);
if(_1610>_160d){
_1610-=7;
}
this._date2cell={};
array.forEach(this.dateCells,function(_1611,idx){
var i=idx+_1610;
var date=new this.dateClassObj(month),_1612,clazz="dijitCalendar",adj=0;
if(i<_160d){
_1612=_160f-_160d+i+1;
adj=-1;
clazz+="Previous";
}else{
if(i>=(_160d+_160e)){
_1612=i-_160d-_160e+1;
adj=1;
clazz+="Next";
}else{
_1612=i-_160d+1;
...
_1611.setAttribute("aria-disabled","true");
}else{
clazz="dijitCalendarEnabledDate "+clazz;
_1611.removeAttribute("aria-disabled");
_1611.setAttribute("aria-selected","false");
}
var _1613=this.getClassForDate(date,this.lang);
if(_1613){
clazz=_1613+" "+clazz;
}
_1611.className=clazz+"Month dijitCalendarDateTemplate";
var _1614=date.valueOf();
this._date2cell[_1614]=_1611;
_1611.dijitDateValue=_1614;
...
},constructor:function(_1615){
this.dateModule=_1615.datePackage?lang.getObject(_1615.datePackage,false):date;
this.dateClassObj=this.dateModule.Date||Date;
this.dateLocaleModule=_1615.datePackage?lang.getObject(_1615.datePackage+".locale",false):_1605;
},_createMonthWidget:function(){
return _160b._MonthWidget({id:this.id+"_mw",lang:this.lang,dateLocaleModule:this.dateLocaleModule},this.monthNode);
},buildRendering:function(){
var d=this.dowTemplateString,_1616=this.dateLocaleModule.getNames("days",this.dayWidth,"standAlone",this.lang),_1617=_1604.getFirstDayOfWeek(this.lang);
this.dayCellsHtml=_1607.substitute([d,d,d,d,d,d,d].join(""),{d:""},function(){
return _1616[_1617++%7];
});
var r=_1607.substitute(this.weekTemplateString,{d:this.dateTemplateString});
this.dateRowsHtml=[r,r,r,r,r,r].join("");
this.dateCells=[];
this.dateLabels=[];
this.inherited(arguments);
dom.setSelectable(this.domNode,false);
var _1618=new this.dateClassObj(this.currentFocus);
this.monthWidget=this._createMonthWidget();
this.set("currentFocus",_1618,false);
},postCreate:function(){
this.inherited(arguments);
this._connectControls();
},_connectControls:function(){
var _1619=lang.hitch(this,function(_161a,part,_161b){
this.connect(this[_161a],"onclick",function(){
this._setCurrentFocusAttr(this.dateModule.add(this.currentFocus,part,_161b));
});
});
_1619("incrementMonth","month",1);
_1619("decrementMonth","month",-1);
_1619("nextYearLabelNode","year",1);
_1619("previousYearLabelNode","year",-1);
},_setCurrentFocusAttr:function(date,_161c){
var _161d=this.currentFocus,_161e=this._getNodeByDate(_161d);
date=this._patchDate(date);
this._set("currentFocus",date);
if(!this._date2cell||this.dateModule.difference(_161d,date,"month")!=0){
this._populateGrid();
this._populateControls();
this._markSelectedDates([this.value]);
}
var _161f=this._getNodeByDate(date);
_161f.setAttribute("tabIndex",this.tabIndex);
if(this.focused||_161c){
_161f.focus();
}
if(_161e&&_161e!=_161f){
if(has("webkit")){
_161e.setAttribute("tabIndex","-1");
}else{
_161e.removeAttribute("tabIndex");
}
}
},focus:function(){
...
if(node&&!_1606.contains(node,"dijitCalendarDisabledDate")){
...
function mark(_1620,cell){
_1606.toggle(cell,"dijitCalendarSelectedDate",_1620);
cell.setAttribute("aria-selected",_1620?"true":"false");
};
...
_160b._MonthWidget=_1603("dijit.CalendarLite._MonthWidget",_1608,{_setMonthAttr:function(month){
var _1621=this.dateLocaleModule.getNames("months","wide","standAlone",this.lang,month),_1622=(has("ie")==6?"":"<div class='dijitSpacer'>"+array.map(_1621,function(s){
return "<div>"+s+"</div>";
}).join("")+"</div>");
this.domNode.innerHTML=_1622+"<div class='dijitCalendarMonthLabel dijitCalendarCurrentMonthLabel'>"+_1621[month.getMonth()]+"</div>";
}});
return _160b;
});
},"davinci/html/CSSElement":function(){
define(["dojo/_base/declare","davinci/model/Model"],function(_1623,Model){
return _1623("davinci.html.CSSElement",Model,{constructor:function(){
...
},_convertNode:function(_1625){
if(dojo.isArray(_1625)){
return _1625;
}
var nodes=[];
while(_1625&&_1625.tagName!="HTML"){
nodes.push({tagName:_1625.tagName,id:_1625.id,classes:(_1625.className&&_1625.className.split(" "))});
_1625=_1625.parentNode;
}
return nodes;
},getID:function(){
return this.parent.getID()+":"+this.startOffset+":"+this.getLabel();
...
define(["dojo/_base/declare","dojo/dom-geometry","davinci/ve/widget","davinci/ve/States","davinci/ve/utils/StyleArray"],function(_1626,_1627,_1628,_1629,_162a){
return _1626("davinci.ve.commands.ResizeCommand",null,{name:"resize",constructor:function(_162b,width,_162c,_162d){
this._id=(_162b?_162b.id:undefined);
var _162e=/^\s*[-+]?[0-9]*\.?[0-9]+\s*$/;
if(_162e.test(width)){
width=parseFloat(width);
}
if(_162e.test(_162c)){
_162c=parseFloat(_162c);
}
this._newBox={w:width,h:_162c};
this._applyToStateIndex=(!_162d||_162d=="Normal"||_162d=="undefined")?"undefined":_162d;
},execute:function(){
if(!this._id||!this._newBox){
return;
}
var _162f=_1628.byId(this._id);
if(!_162f||!_162f.domNode){
return;
}
var node=_162f.domNode;
var cs=node.ownerDocument.defaultView.getComputedStyle(node);
var _1630=_1627.getContentBox(node,cs);
this._oldBox={w:_1630.w,h:_1630.h};
var w=this._newBox.w;
var h=this._newBox.h;
if(this._usesBorderBox(node)){
var pb=_1627.getPadBorderExtents(node,cs);
...
var _1632=_162f.getStyleValuesAllStates();
this._oldStyleValuesAllStates=dojo.clone(_1632);
if(this._oldBox){
this._oldStyleValuesAllStates[this._applyToStateIndex]=_162a.mergeStyleArrays(this._oldStyleValuesAllStates[this._applyToStateIndex],[{width:this._oldBox.w+"px"},{height:this._oldBox.h+"px"}]);
}
if(_1632[this._applyToStateIndex]){
_1632[this._applyToStateIndex]=_162a.mergeStyleArrays(_1632[this._applyToStateIndex],_1631);
}else{
_1632[this._applyToStateIndex]=_1631;
}
_162f.setStyleValuesAllStates(_1632);
var _1633=_1629.getStatesListCurrent(_162f.domNode);
var _1634=_162a.mergeStyleArrays([],_1632["undefined"]);
for(var i=0;i<_1633.length;i++){
if(_1632[_1633[i]]){
_1634=_162a.mergeStyleArrays(_1634,_1632[_1633[i]]);
}
}
_162f.setStyleValuesCanvas(_1634);
_162f.setStyleValuesModel(_1632["undefined"]);
this._resize(_162f);
_1629.resetState(_162f.domNode);
dojo.publish("/davinci/ui/widgetPropertiesChanged",[[_162f]]);
},setContext:function(_1635){
this._context=_1635;
},undo:function(){
if(!this._id){
return;
}
var _1636=_1628.byId(this._id);
if(!_1636){
return;
}
var _1637=this._oldStyleValuesAllStates;
var _1638=this._applyToStateIndex;
_1636.setStyleValuesAllStates(_1637);
var _1639=_162a.mergeStyleArrays(_1637["undefined"],_1637[_1638]);
_1636.setStyleValuesCanvas(_1639);
_1636.setStyleValuesModel(this._oldStyleValuesAllStates["undefined"]);
this._resize(_1636);
_1629.resetState(_1636.domNode);
dojo.publish("/davinci/ui/widgetPropertiesChanged",[[_1636]]);
},_usesBorderBox:function(node){
var _163a=node.tagName.toLowerCase();
var type=node.getAttribute("type");
if(type){
type=type.toLowerCase(type);
}
return _163a=="table"||_163a=="button"||(_163a=="input"&&type=="button");
},_resize:function(_163b){
var _163c=_163b.getParent();
if(_163c&&_163c.dijitWidget&&_163c.dijitWidget.isLayoutContainer){
_163c.resize();
}else{
if(_163b.resize){
_163b.resize();
...
r(["dojo/i18n!*preload*maq-metadata-clipart/clipart/nls/_DeviceClipartHelper*[\"ar\",\"ca\",\"cs\",\"da\",\"de\",\"el\",\"en-gb\",\"en-us\",\"es-es\",\"fi-fi\",\"fr-fr\",\"he-il\",\"hu\",\"it-it\",\"ja-jp\",\"ko-kr\",\"nl-nl\",\"nb\",\"pl\",\"pt-br\",\"pt-pt\",\"ru\",\"sk\",\"sl\",\"sv\",\"th\",\"tr\",\"zh-tw\",\"zh-cn\",\"ROOT\"]"]);
}}});
define("maq-metadata-clipart/clipart/_DeviceClipartHelper",["dojo/_base/declare","dojo/_base/connect","davinci/ve/commands/ResizeCommand"],function(_16fb,_16fc,_16fd){
return _16fb([],{constructor:function(){
_16fc.subscribe("/davinci/ui/widgetPropertiesChanged",function(_16fe){
if(!_16fe){
return;
}
var _16ff=_16fe[0];
if(!_16ff||!_16ff.dijitWidget){
return;
}
var _1700=_16ff.dijitWidget;
if(_1700.DeviceClipart&&_1700.UpdateStyle){
_1700.UpdateStyle();
}
}.bind(this));
},destroy:function(_1701){
var _1702=_1701.getChildren?_1701.getChildren():[];
_1702.forEach(function(each){
if(each.destroyWidget){
each.destroyWidget();
}
});
if(_1701.dijitWidget&&_1701.dijitWidget.destroyRecursive){
_1701.dijitWidget.destroyRecursive();
}
...
var _1703=args.widget;
var _1704=args.compoundCommand;
var _1705=args.modifyCommand;
if(!_1703||!_1704||!_1705){
return;
}
var _1706=(_1703.dijitWidget&&_1703.dijitWidget.orientation);
var _1707=_1705._properties;
var _1708=(_1707&&_1707.orientation);
if(_1706&&_1708&&_1706!=_1708){
var _1709=_1703.getContext();
if(!_1709){
return;
}
var dj=_1709.getDojo();
if(!dj){
return;
}
var _170a=dj.style(_1703.domNode,"width");
var _170b=dj.style(_1703.domNode,"height");
_1704.add(new _16fd(_1703,_170b,_170a));
}
}});
});
