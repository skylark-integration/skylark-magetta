//>>built
define("gridx/modules/Header",["dojo/_base/declare","dojo/_base/lang","dojo/_base/array","dojo/dom-construct","dojo/dom-class","dojo/dom-geometry","dojo/_base/query","dojo/_base/sniff","dojo/keys","../util","../core/_Module"],function(_1,_2,_3,_4,_5,_6,_7,_8,_9,_a,_b){
...
this.innerNode.firstChild.style[ltr?"marginLeft":"marginRight"]=(!ltr&&_8("ff")?_f:-_f)+"px";
this._scrollLeft=_f;
...
var t=this,n=_7("th."+t._focusClass,t.domNode)[0];
if(n){
