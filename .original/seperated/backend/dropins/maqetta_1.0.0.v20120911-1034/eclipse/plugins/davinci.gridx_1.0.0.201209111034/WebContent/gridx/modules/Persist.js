...
t.put(t.arg("key"),_1a,t.arg("options"));
...
var t=this,_21=t.grid,col,_22=[],_23=t.registerAndLoad("column",t._columnStateSaver,t);
if(_3.isArray(_23)){
_2.forEach(_23,function(col){
_2.some(_21._columns,function(c,i){
if(c.id==col.id){
c=_22[col.index]=_21._columns[i];
