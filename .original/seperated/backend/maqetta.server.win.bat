...
java -Dorg.eclipse.equinox.http.jetty.http.port=%port%  -Dmaqetta.baseDirectory="%usersdir%" -Dorion.core.configFile=%scriptdir%\maqetta.conf -jar "%EQUINOX%" -console -noExit -clean -data $absusersdir
